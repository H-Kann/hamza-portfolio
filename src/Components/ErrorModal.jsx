...
export const ErrorModal = ({ isErrorOpen, onErrorClose }) => {
  return (
    <Dialog open={isErrorOpen} onClose={onErrorClose} className="relative z-10">
      <DialogBackdrop
        transition
            ...
            <div className="bg-slate-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-white">Message failed to send</p>
                  </div>
                </div>
              </div>
            </div>
